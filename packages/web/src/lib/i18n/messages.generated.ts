...
export const MESSAGES = [
  ...
  "Add income",
  "Add refund",
  "Add screenshots or a PDF statement with the + button.",
  ...
  "Destination account",
  "Details panel",
  "Details were not saved for this import.",
  ...
  "Historical details are unavailable for this transaction.",
  "Home",
  "Home & bills",
  "Housing",
  ...
  "One import takes either screenshots or a PDF statement, not both.",
  ...
  "Screenshots or a PDF statement",
  ...
  "This PDF has no text layer (a scan). Use screenshots instead.",
