...
export const ICONS: Record<string, string[]> = {
  ...
  gift: [
    ...
    "M3 7.5h18V12H3z",
    "M12 7.5v13",
    "M12 7.5S9.6 3.6 7.2 4.8C5.4 5.7 9 7.5 12 7.5z",
    "M12 7.5s2.4-3.9 4.8-2.7C18.6 5.7 15 7.5 12 7.5z",
  ],
  ...
  food: [
    "M7 3.2v4.3",
    "M7 7.5c-1 0-1.6-.6-1.6-2.1V3.2",
    "M7 7.5c1 0 1.6-.6 1.6-2.1V3.2",
    "M7 7.5v13.3",
    "M16 3.2c-1.4 0-2 2-2 4.4 0 2.1.6 3.3 2 3.3",
    "M16 3.2v17.6",
  ],
  ...
  piggy: [
    "M12 5.5c4.2 0 7.5 2.7 7.5 6.1 0 3.4-3.3 6.1-7.5 6.1S4.5 15 4.5 11.6 7.8 5.5 12 5.5z",
    "M9.8 5.8L9.4 4h5.2l-.4 1.8",
    "M8 17.4l-.4 2",
    "M16 17.4l.4 2",
    "M15.6 10.4h.4",
  ],
  ...
  apple: [
    "M12 7.5c-1-.8-2.4-1.2-3.7-.7C5.9 7.7 5 10.4 5.8 13.2c.8 2.9 2.8 5.6 4.7 5.3.6-.1 1-.4 1.5-.4s.9.3 1.5.4c1.9.3 3.9-2.4 4.7-5.3.8-2.8-.1-5.5-2.5-6.4-1.3-.5-2.7-.1-3.7.7z",
    "M12 7.5c0-2 1.3-3.3 3-3.5",
  ],
  ...
  cake: [
    "M5 12h14v8.5H5z",
    "M5 15.5c1.2 0 1.2 1 2.3 1s1.2-1 2.3-1 1.2 1 2.4 1 1.1-1 2.3-1 1.2 1 2.3 1 1.2-1 2.4-1",
    "M12 12V8.5",
    "M12 6a1.2 1.2 0 001.2-1.2c0-.8-1.2-2-1.2-2s-1.2 1.2-1.2 2A1.2 1.2 0 0012 6z",
  ],
  ...
  gamepad: [
    "M7 8.5h10a5 5 0 015 5 3 3 0 01-5.3 1.9L15 13.5H9l-1.7 1.9A3 3 0 012 13.5a5 5 0 015-5z",
    "M8 10.5v2.6",
    "M6.7 11.8h2.6",
    "M15.8 10.8h.4",
    "M17.8 12.8h.4",
...
export const ICON_CATEGORIES: Array<{ label: Message; icons: string[] }> = [
  {
    ...
    icons: ["wallet", "card", "banknote", "coins", "piggy", "safe", "moneybag", "receipt", "cart", "shopbag", "store", "percent", "scales", "briefcase", "tag"],
  },
