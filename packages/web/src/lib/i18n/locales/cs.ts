...
export const cs: Dict = {
  ...
  "Only {fundable} of {amount} available in To be budgeted": "V K rozdělení je dostupných jen {fundable} z {amount}",
  ...
  "{amount} from To be budgeted ({pool} available)": "{amount} z K rozdělení ({pool} k dispozici)",
