...
export const pl: Dict = {
  ...
  "Balance in the bank": "Saldo w banku",
  "Balance matches the bank": "Saldo zgadza się z bankiem",
  "Difference: {amount}": "Różnica: {amount}",
  "Match the selection to the bank balance": "Dopasuj zaznaczenie do salda w banku",
  ...
  "Reverse direction: {row}": "Odwróć kierunek: {row}",
  "{n} other combination also fits the balance. | {n} other combinations also fit the balance.": {
    one: "Do salda pasuje też {n} inna kombinacja.",
    few: "Do salda pasują też {n} inne kombinacje.",
    many: "Do salda pasuje też {n} innych kombinacji.",
    other: "Do salda pasuje też {n} innych kombinacji.",
  },
  ...
  "Reconcile the account to the bank balance after adding": "Wyrównaj konto do salda w banku po dodaniu",
