...
export const it: Dict = {
  ...
  "Google sign-in keeps you signed in until you sign out — remember to sign out when you finish.":
    "L'accesso con Google ti mantiene connesso finché non esci — ricordati di uscire quando hai finito.",
  ...
  "Keep me signed in and save a local copy so Enveo works without internet.": "Resta connesso e salva una copia locale, così Enveo funziona anche offline.",
  Language: "Lingua",
  ...
  "No local copy will be saved. This browser session ends when you close the app.":
    "Nessuna copia locale verrà salvata. Questa sessione del browser termina quando chiudi l'app.",
  ...
  "The local copy — including any unsent changes — will be permanently removed from this device. Your account's data on the server is not affected.":
    "La copia locale — comprese le modifiche non inviate — verrà rimossa definitivamente da questo dispositivo. I dati del tuo account sul server non saranno interessati.",
  ...
  "This is my private device": "Questo è il mio dispositivo privato",
  ...
  "When you spend": "Quando spendi",
  "Overspends, pace risks and shortfalls": "Sforamenti, rischi di ritmo e mancanze",
  "6-month sparklines": "Mini-grafici di 6 mesi",
  "daily spending heatmap": "Mappa di calore delle spese giornaliere",
  "{name} is overspent": "{name}: budget superato",
  "{n} envelope is overspent | {n} envelopes are overspent": {
    one: "{n} busta ha superato il budget",
    many: "{n} buste hanno superato il budget",
    other: "{n} buste hanno superato il budget",
  },
  "{name} will overspend at this pace": "{name}: a questo ritmo il budget sarà superato",
  "Unassigned money is sitting in the pool": "C’è denaro non assegnato nel fondo comune",
  "You assigned more than you have": "Hai assegnato più di quanto hai",
  "{n} goal is short this month | {n} goals are short this month": {
    one: "{n} obiettivo non è raggiunto questo mese",
    many: "{n} obiettivi non sono raggiunti questo mese",
    other: "{n} obiettivi non sono raggiunti questo mese",
  },
  "{name} is in the red": "{name} è in rosso",
  "{n} account is in the red | {n} accounts are in the red": {
    one: "{n} conto è in rosso",
    many: "{n} conti sono in rosso",
    other: "{n} conti sono in rosso",
  },
  "Nothing needs you right now": "Al momento non c’è nulla che richieda attenzione",
  "Cover it ›": "Copri ›",
  "Top up ›": "Ricarica ›",
  "Suggest ›": "Suggerisci ›",
  "Budget ›": "Budget ›",
  ...
  "total {amount} this month": "totale {amount} questo mese",
  "No spending this month.": "Nessuna spesa questo mese.",
  "Not enough history yet — trends appear after two months of spending.": "Non c’è ancora abbastanza storico — le tendenze appaiono dopo due mesi di spese.",
  // Wide Home board — edit mode (PR5 Task 6)
  "Add widget": "Aggiungi widget",
  "Every widget is already on the grid.": "Tutti i widget sono già sulla griglia.",
  ...
  "+ {n} more | + {n} more": { one: "+ altri {n}", many: "+ altri {n}", other: "+ altri {n}" },
  "A local copy means the app opens instantly and keeps working on a plane.":
    "Una copia locale significa che l'app si apre all'istante e continua a funzionare anche in aereo.",
  "A negative balance is fine — that is how a credit card starts.": "Un saldo negativo va benissimo — è così che parte, ad esempio, una carta di credito.",
  "A pairing code moves the key from an unlocked device — paste only, no QR scanning.":
    "Un codice di abbinamento trasferisce la chiave da un dispositivo già sbloccato — si incolla soltanto, nessuna scansione QR.",
  "A user id can change when a self-hosted server is rebuilt — same e-mail, new account.":
    "L'id utente può cambiare quando un server self-hosted viene ricostruito — stessa e-mail, nuovo account.",
  "AI through Enveo's key stays off while encryption is on — your own OpenAI key still works, straight from this device.":
    "L'IA tramite la chiave di Enveo resta disattivata finché la crittografia è attiva — la tua chiave OpenAI personale continua a funzionare, direttamente da questo dispositivo.",
  "Add Enveo to this device": "Aggiungi Enveo a questo dispositivo",
  "Choose a report to open it here.": "Scegli un report per aprirlo qui.",
  "Choose an account to see its details.": "Scegli un conto per vederne i dettagli.",
  "Choose an envelope to see its summary.": "Scegli una busta per vederne il riepilogo.",
  "Cover the overspend in {name}": "Copri lo sforamento in {name}",
  "Cover {amount}": "Copri {amount}",
  "Covered {amount} in {name}": "Coperto {amount} in {name}",
  "Details panel": "Pannello dei dettagli",
  "Dismiss this step for now": "Ignora per ora questo passaggio",
  "Enveo keeps a full local copy of the budget, so it works offline and syncs when you are back. Accounts are mandatory — the copy has to belong to somebody.":
    "Enveo mantiene una copia locale completa del bilancio, così funziona offline e si sincronizza al tuo ritorno. Gli account sono obbligatori — la copia deve appartenere a qualcuno.",
  "Every write to the server is already blocked. Nothing has been deleted, because the decision is yours: the copy on this device may be the last one that exists.":
    "Ogni scrittura verso il server è già bloccata. Non è stato cancellato nulla, perché la decisione spetta a te — la copia su questo dispositivo potrebbe essere l'unica rimasta.",
  "Export first: the JSON backup is written offline, without the server.": "Esporta prima: il backup JSON viene scritto offline, senza il server.",
  "Fill all goals ›": "Completa tutti gli obiettivi ›",
  "Fill {amount} ›": "Completa {amount} ›",
  "Filled {amount} in {name}": "Completato {amount} in {name}",
  "Hide the side panel": "Nascondi il pannello laterale",
  Ignore: "Ignora",
  In: "Entrate",
  "Language and currency": "Lingua e valuta",
  "Language, one account, a set of envelopes. Everything can be renamed, moved or archived later — nothing here is permanent.":
    "Lingua, un account, un insieme di buste. Tutto si può rinominare, spostare o archiviare più avanti — niente qui è definitivo.",
  "Left over": "Rimasto",
  "Left over = income minus spending that month. Last 12 months, newest first.": "Rimasto = entrate meno spese in quel mese. Ultimi 12 mesi, dal più recente.",
  "Met in {n} of 5 months · ✓ = fully funded that month": "Raggiunto in {n} mesi su 5 · ✓ = quel mese finanziato per intero",
  "Move the missing amount from To be budgeted into this envelope": "Sposta l'importo mancante da Da assegnare a questa busta",
  "Next day": "Giorno successivo",
  "No category": "Nessuna categoria",
  "No envelope": "Nessuna busta",
  "No group": "Nessun gruppo",
  "No place": "Nessun luogo",
  "No spending this day.": "Nessuna spesa in questo giorno.",
  "Nothing is open in this panel yet.": "In questo pannello non c'è ancora niente di aperto.",
  "Nothing to fix right now ✓": "Al momento non c'è niente da sistemare ✓",
  ...
  "Only {fundable} of {amount} available in To be budgeted": "In Da assegnare sono disponibili solo {fundable} di {amount}",
  ...
  "Pick at least one envelope.": "Scegli almeno una busta.",
  "Plan closed — every envelope holds": "Piano chiuso — ogni busta regge",
  "Previous day": "Giorno precedente",
  "Removing the local copy is the only destructive action here.": "Rimuovere la copia locale è l'unica azione distruttiva qui.",
  "Savings rate this month: {pct}%": "Tasso di risparmio questo mese: {pct}%",
  "Self-hosted or cloud — the same build, the same data model.": "Self-hosted o cloud — la stessa build, lo stesso modello di dati.",
  "Show all": "Mostra tutto",
  "Show the side panel": "Mostra il pannello laterale",
  "Sign-in is per device: a shared computer can stay session-only.": "L'accesso è per dispositivo — un computer condiviso può restare solo di sessione.",
  "The data is encrypted on the device before it reaches the server. Only the encryption password — or a pairing code from a device that is already unlocked — can open it here.":
    "I dati vengono cifrati sul dispositivo prima di raggiungere il server. Solo la password di cifratura — o un codice di abbinamento da un dispositivo già sbloccato — può aprirli qui.",
  "The flat line in each spark marks that envelope's median.": "La linea piatta in ogni mini grafico segna la mediana di quella busta.",
  "The server stores ciphertext and never sees the password.": "Il server conserva solo dati cifrati e non vede mai la password.",
  "This budget is end-to-end encrypted.": "Questo bilancio è cifrato end-to-end.",
  "This device holds someone else's budget.": "Questo dispositivo contiene il bilancio di qualcun altro.",
  "This step was ignored — click to bring it back": "Questo passaggio è stato ignorato — tocca per farlo tornare",
  "Three steps and the budget is yours.": "Tre passaggi e il bilancio è tuo.",
  "Top up {amount}": "Ricarica {amount}",
  "Top up {name} — almost at the limit": "Ricarica {name} — quasi al limite",
  "Top up {name} — its pace will bust the budget": "Ricarica {name} — con questo ritmo sforerà il bilancio",
  "Topped up {amount} in {name}": "Ricaricato {amount} in {name}",
  Undo: "Annulla",
  "Your budget is ready.": "Il tuo bilancio è pronto.",
  "Your budget is tied to your account.": "Il tuo bilancio è legato al tuo account.",
  "at this pace ≈ {projected} against a {budget} budget": "con questo ritmo ≈ {projected} contro un bilancio di {budget}",
  "ignored ↩": "ignorato ↩",
  "net per month · scale ±{max}": "netto al mese · scala ±{max}",
  "vs the {avg} daily average": "vs la media giornaliera di {avg}",
  "{amount} from To be budgeted ({pool} available)": "{amount} da Da assegnare ({pool} disponibile)",
  "{funded} of {target}": "{funded} di {target}",
  "{left} left · {pct}% of the budget spent": "restano {left} · {pct}% del bilancio speso",
  "{month} so far: {pct}%": "{month} finora: {pct}%",
  "{month} · ended at {pct}% of the goal": "{month} · terminato al {pct}% dell'obiettivo",
  "{month} · goal fully funded ✓": "{month} · obiettivo finanziato per intero ✓",
  "{month} · so far {pct}%": "{month} · finora {pct}%",
  "{name} moved the most this month — {amount} vs median": "{name} si è mossa di più questo mese — {amount} vs mediana",
  "{name} {pct}%": "{name} {pct}%",
  "{now} · median {median}": "{now} · mediana {median}",
  "{n} envelope selected | {n} envelopes selected": { one: "{n} busta selezionata", many: "{n} buste selezionate", other: "{n} buste selezionate" },
  "{n} healthy envelope | {n} healthy envelopes": { one: "{n} busta in regola", many: "{n} buste in regola", other: "{n} buste in regola" },
  "{n} healthy envelope · {ignored} ignored | {n} healthy envelopes · {ignored} ignored": {
    one: "{n} busta in regola · {ignored} ignorate",
    many: "{n} buste in regola · {ignored} ignorate",
    other: "{n} buste in regola · {ignored} ignorate",
  },
  "{n} of {m} envelopes is healthy | {n} of {m} envelopes are healthy": {
    one: "{n} busta su {m} è in regola",
    many: "{n} buste su {m} sono in regola",
    other: "{n} buste su {m} sono in regola",
  },
