...
export const pl: Dict = {
  ...
  "Pending on the screenshots ({n} in another currency not counted)": "Oczekujące na zrzutach ({n} w innej walucie nie policzono)",
  "Pending on the screenshots": "Oczekujące na zrzutach",
  "Available after import": "Dostępne po imporcie",
  "Which balance the bank shows": "Które saldo pokazuje bank",
