...
export const nl: Dict = {
  ...
  "Move {sum}": "{sum} verplaatsen",
  "Moving {sum} of {amount}": "{sum} van {amount} wordt verplaatst",
  "Needs {amount} · pick where it comes from": "Er ontbreekt {amount} · kies waar het vandaan komt",
