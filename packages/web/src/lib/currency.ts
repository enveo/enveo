...
export const CURRENCY_DIGITS: Readonly<Record<string, number>> = {
  ...
  CLP: 0, COP: 0, HUF: 0, IDR: 0, ISK: 0, JPY: 0, KRW: 0, VND: 0, // no minor unit at all
  BHD: 3, KWD: 3, // 1/1000 of the major unit
};
...
const REGION_CURRENCY: Record<string, SupportedCurrency> = {
  ...
  // the Americas (everything unmapped falls back to USD anyway — CO is unmapped: COP is 0-decimal)
  US: "USD", CA: "CAD", BR: "BRL", MX: "MXN", AR: "ARS", PE: "PEN",
  // Asia-Pacific (ID is unmapped: IDR is 0-decimal, so Indonesia gets the USD fallback)
