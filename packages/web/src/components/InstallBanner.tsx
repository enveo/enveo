...
export function InstallBanner() {
  ...
  return (
    ...
    <div className="fu" role="dialog" aria-label={t("Add Enveo to your phone")} aria-live="polite" style={{ position: "fixed", left: 12, right: 12, bottom: "calc(78px + env(safe-area-inset-bottom))", maxWidth: 396, margin: "0 auto", zIndex: 80, background: C.surface, border: `1px solid ${C.line}`, borderRadius: 14, padding: "14px 16px", boxShadow: "0 8px 30px rgba(0,0,0,0.18)" }}>
