...
// API responses must never be cached. The post-next mutation also covers
// auth, origin-guard, 404, and other responses produced by later middleware.
...
app.onError((err, c) => {
  // Exceptions skip the post-next portion of middleware, so apply the cache
  // policy here as well for errors generated by API handlers.
