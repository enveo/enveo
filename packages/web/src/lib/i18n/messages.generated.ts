...
export const MESSAGES = [
  ...
  "Guest session: your budget is kept in memory only and disappears when you close the browser.",
  "Health",
  "Health & fitness",
  "Home",
  "Home & bills",
  ...
  "Sign out? The local copy will be removed from this device — your data stays on the server.",
  "Sign out? Your data stays on this device and on the server.",
  "Signing out…",
  "Signs you out and removes the local copy from this device. Your data stays on the server and comes back when you sign in again.",
  ...
  "Some changes have not reached the server yet. Sign out anyway and lose them?",
  ...
  "Transfer",
  "Transport",
  "Trust this device — remember my data and sign-in",
  "Try again",
