...
export const MESSAGES = [
  ...
  "Manage envelopes",
  "Manage…",
  "Match the selection to the bank balance",
  ...
  "Reconcile",
  "Reconcile account",
  "Reconcile the account to the bank balance after adding",
  ...
  "{account}: {before} now, {after} after import",
