...
import { budgetPace, budgetRowPresentation, budgetSteps, budgetUsage, compareBudgetUsageRows, monthProgress } from "../../lib/reportSummary";
                    ...
                    <div style={{ display: "flex", gap: 11 }}>
                      ...
                      <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column", gap: 5 }}>
                        ...
                        <span style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                          {/* TODO(task 3): wire to a real allocation with an undo toast — presentation only this task, so the
                              button stays disabled; the fundable-based dimming below is the real domain rule and is already correct. */}
                          <button
                            disabled
                            style={{
                              cursor: "default",
