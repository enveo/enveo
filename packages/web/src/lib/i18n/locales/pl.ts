...
export const pl: Dict = {
  ...
  "Delete selected ({count})": "Usuń zaznaczone ({count})",
  "Delete selected imports? Screenshots and retry data will be removed. Transactions already added to the budget will stay.":
    "Usunąć zaznaczone importy? Zrzuty ekranu i dane potrzebne do ponowienia zostaną usunięte. Transakcje już dodane do budżetu pozostaną bez zmian.",
  ...
  "Declined by the bank": "Odrzucona przez bank",
  ...
  "Choosing the best match…": "Wybieram najlepsze dopasowanie…",
  "Balance reconciliation": "Uzgodnienie salda",
  "In the app now": "W apce teraz",
  "Selected rows": "Zaznaczone wiersze",
  "After import": "Po imporcie",
  "{account} after import": "{account} po imporcie",
  "Bank shows": "Bank pokazuje",
  "Type the balance": "Wpisz saldo",
  "Matches the bank": "Zgadza się z bankiem",
  Difference: "Różnica",
  "Match to the bank balance": "Dopasuj do salda w banku",
  "Uncheck {row}": "Odznacz {row}",
  "Check {row}": "Zaznacz {row}",
  "Reverse {row}": "Odwróć {row}",
  "After changes": "Po zmianach",
  "{n} other combination also fits. | {n} other combinations also fit.": {
    one: "Pasuje też {n} inna kombinacja.",
    few: "Pasują też {n} inne kombinacje.",
    many: "Pasuje też {n} innych kombinacji.",
    other: "Pasuje też {n} innych kombinacji.",
  },
  "Reconcile to the bank balance after adding": "Wyrównaj do salda w banku po dodaniu",
  "Suggested changes": "Proponowane zmiany",
  "The selection changed since this suggestion. Match again.": "Zaznaczenie zmieniło się od tej propozycji. Dopasuj ponownie.",
  "Apply changes": "Zastosuj zmiany",
  Dismiss: "Odrzuć",
  "No combination of uncertain rows explains the difference.": "Żadna kombinacja niepewnych wierszy nie wyjaśnia różnicy.",
  ...
  "Closest fit": "Najbliższe dopasowanie",
  "Still unexplained": "Nadal niewyjaśnione",
  "Apply the closest fit": "Zastosuj najbliższe",
  "Entered by hand in this period, worth a second look:": "Wpisane ręcznie w tym okresie, warto sprawdzić:",
  "No name": "Bez nazwy",
  "The uncertain rows could explain at most {amount}. A transaction is probably missing from the screenshots, or the app already differed from the bank before this import.":
    "Niepewne wiersze wyjaśniają najwyżej {amount}. Najpewniej brakuje transakcji między zrzutami albo apka różniła się od banku już przed tym importem.",
  ...
  "Retry started. Follow it in Imports.": "Ponowienie rozpoczęte. Śledź je w Importach.",
  "{n} screenshot was left out — add it in another import. | {n} screenshots were left out — add them in another import.": {
    one: "{n} zrzut ekranu został pominięty — dodaj go w kolejnym imporcie.",
    few: "{n} zrzuty ekranu zostały pominięte — dodaj je w kolejnym imporcie.",
    many: "{n} zrzutów ekranu zostało pominiętych — dodaj je w kolejnym imporcie.",
    other: "{n} zrzutów ekranu zostało pominiętych — dodaj je w kolejnym imporcie.",
  },
  "{n} screenshot could not be read. It waits in Imports as a separate import you can retry. | {n} screenshots could not be read. They wait in Imports as a separate import you can retry.":
    {
      one: "{n} zrzutu ekranu nie udało się odczytać. Czeka w Importach jako osobny import, który możesz ponowić.",
      few: "{n} zrzutów ekranu nie udało się odczytać. Czekają w Importach jako osobny import, który możesz ponowić.",
      many: "{n} zrzutów ekranu nie udało się odczytać. Czekają w Importach jako osobny import, który możesz ponowić.",
      other: "{n} zrzutów ekranu nie udało się odczytać. Czekają w Importach jako osobny import, który możesz ponowić.",
    },
  ...
  "Select import from {date}": "Zaznacz import z {date}",
  ...
  "Import from a file": "Import z pliku",
  "Import a file": "Importuj plik",
  "Screenshots of Apple Wallet or your bank history, or a PDF statement — AI will recognize the transactions, duplicates will be skipped":
    "Zrzuty ekranu z Apple Wallet lub historii banku albo wyciąg PDF — AI rozpozna transakcje, duplikaty pominiemy",
  "Files ({n}/{max})": "Pliki ({n}/{max})",
  "Add files": "Dodaj pliki",
  "Screenshots or a PDF statement": "Zrzuty ekranu albo wyciąg PDF",
  "Process files": "Przetwórz pliki",
  "Add screenshots or a PDF statement with the + button.": "Dodaj zrzuty ekranu albo wyciąg PDF przyciskiem +.",
  ...
  "Cancel selection": "Anuluj zaznaczanie",
  ...
  "Screenshots ({n}/{max})": "Zrzuty ekranu ({n}/{max})",
  ...
  Ready: "Gotowe",
  "Ready to review": "Gotowe do sprawdzenia",
  "Recently completed": "Ostatnio zakończone",
  "Remove from this device": "Usuń z tego urządzenia",
  "Retry import": "Ponów import",
  "Review import": "Sprawdź import",
  ...
  "Some rows were already added before the interruption. They now appear as existing and will not be added twice.":
    "Niektóre wiersze dodano przed przerwaniem. Teraz są oznaczone jako istniejące i nie zostaną dodane ponownie.",
  "The AI answer could not be validated. Retry the import or choose another model.":
    "Nie udało się zweryfikować odpowiedzi AI. Ponów import albo wybierz inny model.",
  "The AI service took too long to answer. You can retry this import.": "Usługa AI odpowiadała zbyt długo. Możesz ponowić ten import.",
  ...
  "The selected AI model is unavailable. Choose another model before retrying.": "Wybrany model AI jest niedostępny. Przed ponowieniem wybierz inny model.",
  "The signed-in account changed. Reload the app before retrying this import.": "Zalogowane konto się zmieniło. Przed ponowieniem importu przeładuj aplikację.",
  "The source account is no longer available. Start a new import with another account.":
    "Konto źródłowe nie jest już dostępne. Rozpocznij nowy import z innym kontem.",
  "The source account was deleted or archived. This import cannot be applied.":
    "Konto źródłowe zostało usunięte lub zarchiwizowane. Nie można zastosować tego importu.",
  "This import expired. Start a new import from the screenshots.": "Ten import wygasł. Rozpocznij nowy import ze zrzutów ekranu.",
  "This import runs directly between this device and OpenAI. On a shared device it cannot survive closing or reloading the app.":
    "Ten import jest wykonywany bezpośrednio między tym urządzeniem a OpenAI. Na urządzeniu współdzielonym nie przetrwa zamknięcia ani przeładowania aplikacji.",
  "Uploading screenshots…": "Wysyłanie zrzutów ekranu…",
  "Waiting for a network connection…": "Oczekiwanie na połączenie z siecią…",
