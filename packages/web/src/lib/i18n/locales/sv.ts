...
export const sv: Dict = {
  ...
  "When you spend": "När du spenderar",
  "Overspends, pace risks and shortfalls": "Överskridanden, temporisker och underskott",
  "6-month sparklines": "Minigrafer för 6 månader",
  "daily spending heatmap": "Värmekarta över dagliga utgifter",
  "{name} is overspent": "{name}: budgeten är överskriden",
  "{n} envelope is overspent | {n} envelopes are overspent": {
    one: "{n} kuvert har överskridit budgeten",
    other: "{n} kuvert har överskridit budgeten",
  },
  "{name} will overspend at this pace": "{name}: i den här takten går budgeten över",
  "Unassigned money is sitting in the pool": "Otilldelade pengar ligger i poolen",
  "You assigned more than you have": "Du har tilldelat mer än du har",
  "{n} goal is short this month | {n} goals are short this month": {
    one: "{n} mål är inte uppfyllt denna månad",
    other: "{n} mål är inte uppfyllda denna månad",
  },
  "{name} is in the red": "{name} ligger på minus",
  "{n} account is in the red | {n} accounts are in the red": { one: "{n} konto ligger på minus", other: "{n} konton ligger på minus" },
  "Nothing needs you right now": "Just nu behövs ingen åtgärd",
  "Cover it ›": "Täck ›",
  "Top up ›": "Fyll på ›",
  "Suggest ›": "Föreslå ›",
  "Budget ›": "Budget ›",
  ...
  "A negative balance is fine — that is how a credit card starts.": "Ett negativt saldo är helt okej — så börjar till exempel ett kreditkort.",
  "A pairing code moves the key from an unlocked device — paste only, no QR scanning.":
    "En parkopplingskod flyttar nyckeln från en upplåst enhet — bara klistra in, ingen QR-skanning.",
  "A user id can change when a self-hosted server is rebuilt — same e-mail, new account.":
    "Ett användar-id kan ändras när en självhostad server byggs om — samma e-post, nytt konto.",
  "AI through Enveo's key stays off while encryption is on — your own OpenAI key still works, straight from this device.":
    "AI via Enveos nyckel förblir avstängd så länge kryptering är på — din egen OpenAI-nyckel fungerar ändå, direkt från den här enheten.",
  "Add Enveo to this device": "Lägg till Enveo på den här enheten",
  "Choose a report to open it here.": "Välj en rapport för att öppna den här.",
  "Choose an account to see its details.": "Välj ett konto för att se detaljerna.",
  "Choose an envelope to see its summary.": "Välj ett kuvert för att se sammanfattningen.",
  "Cover the overspend in {name}": "Täck överdraget i {name}",
  "Cover {amount}": "Täck {amount}",
  "Covered {amount} in {name}": "Täckte {amount} i {name}",
  "Details panel": "Detaljpanel",
  "Dismiss this step for now": "Ignorera det här steget tills vidare",
  "Enveo keeps a full local copy of the budget, so it works offline and syncs when you are back. Accounts are mandatory — the copy has to belong to somebody.":
    "Enveo håller en fullständig lokal kopia av budgeten, så den fungerar offline och synkar när du är tillbaka. Konton är obligatoriska — kopian måste tillhöra någon.",
  "Every write to the server is already blocked. Nothing has been deleted, because the decision is yours: the copy on this device may be the last one that exists.":
    "Alla skrivningar till servern är redan blockerade. Inget har raderats, för beslutet är ditt — kopian på den här enheten kan vara den sista som finns kvar.",
  "Export first: the JSON backup is written offline, without the server.": "Exportera först: JSON-säkerhetskopian skrivs offline, utan servern.",
  "Fill all goals ›": "Fullfölj alla mål ›",
  "Fill {amount} ›": "Fullfölj {amount} ›",
  "Filled {amount} in {name}": "Fyllde {amount} i {name}",
  "Hide the side panel": "Dölj sidopanelen",
  Ignore: "Ignorera",
  In: "In",
  "Language and currency": "Språk och valuta",
  "Language, one account, a set of envelopes. Everything can be renamed, moved or archived later — nothing here is permanent.":
    "Språk, ett konto, en uppsättning kuvert. Allt kan döpas om, flyttas eller arkiveras senare — inget här är permanent.",
  "Left over": "Kvar",
  "Left over = income minus spending that month. Last 12 months, newest first.":
    "Kvar = inkomster minus utgifter den månaden. Senaste 12 månaderna, nyaste först.",
  "Met in {n} of 5 months · ✓ = fully funded that month": "Uppnått {n} av 5 månader · ✓ = den månaden fullt finansierad",
  "Move the missing amount from To be budgeted into this envelope": "Flytta det saknade beloppet från Att budgetera till det här kuvertet",
  "Next day": "Nästa dag",
  "No category": "Ingen kategori",
  "No envelope": "Inget kuvert",
  "No group": "Ingen grupp",
  "No place": "Ingen plats",
  "No spending this day.": "Inga utgifter den här dagen.",
  "Nothing is open in this panel yet.": "Inget är öppet i den här panelen än.",
  "Nothing to fix right now ✓": "Inget att fixa just nu ✓",
  ...
  "Only {fundable} of {amount} available in To be budgeted": "Bara {fundable} av {amount} är tillgängligt i Att budgetera",
  ...
  "Pick at least one envelope.": "Välj minst ett kuvert.",
  "Plan closed — every envelope holds": "Plan avslutad — varje kuvert håller",
  "Previous day": "Föregående dag",
  "Removing the local copy is the only destructive action here.": "Att ta bort den lokala kopian är den enda oåterkalleliga åtgärden här.",
  "Savings rate this month: {pct}%": "Sparkvot den här månaden: {pct}%",
  "Self-hosted or cloud — the same build, the same data model.": "Självhostad eller molnet — samma version, samma datamodell.",
  "Show all": "Visa alla",
  "Show the side panel": "Visa sidopanelen",
  "Sign-in is per device: a shared computer can stay session-only.": "Inloggningen gäller per enhet — en delad dator kan hållas till bara sessionen.",
  "The data is encrypted on the device before it reaches the server. Only the encryption password — or a pairing code from a device that is already unlocked — can open it here.":
    "Datan krypteras på enheten innan den når servern. Bara krypteringslösenordet — eller en parkopplingskod från en redan upplåst enhet — kan öppna den här.",
  "The flat line in each spark marks that envelope's median.": "Den raka linjen i varje minigraf markerar det kuvertets median.",
  "The server stores ciphertext and never sees the password.": "Servern lagrar bara krypterad text och ser aldrig lösenordet.",
  "This budget is end-to-end encrypted.": "Den här budgeten är totalsträckskrypterad.",
  "This device holds someone else's budget.": "Den här enheten har någon annans budget.",
  "This step was ignored — click to bring it back": "Det här steget ignorerades — klicka för att ta tillbaka det",
  "Three steps and the budget is yours.": "Tre steg, så är budgeten din.",
  "Top up {amount}": "Fyll på {amount}",
  "Top up {name} — almost at the limit": "Fyll på {name} — nästan vid gränsen",
  "Top up {name} — its pace will bust the budget": "Fyll på {name} — i den här takten spränger det budgeten",
  "Topped up {amount} in {name}": "Fyllde på {amount} i {name}",
  Undo: "Ångra",
  "Your budget is ready.": "Din budget är klar.",
  "Your budget is tied to your account.": "Din budget är knuten till ditt konto.",
  "at this pace ≈ {projected} against a {budget} budget": "i den här takten ≈ {projected} mot en budget på {budget}",
  "ignored ↩": "ignorerat ↩",
  "net per month · scale ±{max}": "netto per månad · skala ±{max}",
  "vs the {avg} daily average": "vs dagssnittet {avg}",
  "{amount} from To be budgeted ({pool} available)": "{amount} från Att budgetera ({pool} tillgängligt)",
  "{funded} of {target}": "{funded} av {target}",
  "{left} left · {pct}% of the budget spent": "{left} kvar · {pct}% av budgeten spenderad",
  "{month} so far: {pct}%": "{month} hittills: {pct}%",
  "{month} · ended at {pct}% of the goal": "{month} · slutade på {pct}% av målet",
  "{month} · goal fully funded ✓": "{month} · målet fullt finansierat ✓",
  "{month} · so far {pct}%": "{month} · hittills {pct}%",
  "{name} moved the most this month — {amount} vs median": "{name} rörde sig mest den här månaden — {amount} vs median",
  "{name} {pct}%": "{name} {pct}%",
  "{now} · median {median}": "{now} · median {median}",
  "{n} envelope selected | {n} envelopes selected": { one: "{n} kuvert markerat", other: "{n} kuvert markerade" },
  "{n} healthy envelope | {n} healthy envelopes": { one: "{n} sunt kuvert", other: "{n} sunda kuvert" },
  "{n} healthy envelope · {ignored} ignored | {n} healthy envelopes · {ignored} ignored": {
    one: "{n} sunt kuvert · {ignored} ignorerade",
    other: "{n} sunda kuvert · {ignored} ignorerade",
  },
  "{n} of {m} envelopes is healthy | {n} of {m} envelopes are healthy": {
    one: "{n} av {m} kuvert är sunt",
    other: "{n} av {m} kuvert är sunda",
  },
